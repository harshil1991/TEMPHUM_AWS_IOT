...
char wifi_password[]   = "XXXXX";
char aws_endpoint[]    = "XXXXX.iot.us-east-1.amazonaws.com";
char aws_key[]         = "XXXXX";
...
void loop() {
  ...
  String f = String(dht.readTemperature());
  ...
  //String values = "{\"state\":{\"reported\":{\"temp\": \"10\",\"humidity\": \"10\"}}}";
